...
<head>
    ...
    <title>Scholarship - Post Graduation </title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <header>
        <h1>Scholarship - Post Graduation</h1>
    </header>
    <section>
        <h2>Congratulations! You are eligible for the Post Graduation  Scholarship.</h2>
    ...
    <section id="instructions">
         ...
         <?php include "instructions/pg.php";?>
