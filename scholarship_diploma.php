...
<head>
    ...
    <title>Scholarship - Diploma </title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <header>
        <h1>Scholarship -  Diploma </h1>
    </header>
    <section>
        <h2>Congratulations! You are eligible for the Diploma  Scholarship.</h2>
    ...
    <section id="instructions">
         ...
         <?php include "instructions/diploma.php";?>
