...
<head>
    ...
    <title>Scholarship - Below 10th</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <header>
        <h1>Scholarship - Below 10th</h1>
    </header>
    <section>
        <h2>Congratulations! You are eligible for the Below 10th Scholarship.</h2>
    ...
    <section id="instructions">
         ...
         <?php include "instructions/below_10th.php";?>
