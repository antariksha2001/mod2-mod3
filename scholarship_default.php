...
<head>
    ...
    <title>Scholarship - Default</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <header>
        <h1>Scholarship - Default</h1>
    </header>
    <section>
        <h2>Sorry! You are not eligible for any specific scholarship based on the selected options.</h2>
        <!-- Add additional information or suggestions here -->
